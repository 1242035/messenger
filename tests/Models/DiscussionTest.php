...
class DiscussionTest extends TestCase
{
    ...
    public function it_can_get_participants_custom_string()
    {
        ...
        static::assertSame(
            '#1 from [Viauco\Messenger\Tests\Stubs\Models\User], #2 from [Viauco\Messenger\Tests\Stubs\Models\User], #3 from [Viauco\Messenger\Tests\Stubs\Models\User]',
    ...
    public function it_get_all_latest_discussions()
    {
        ...
        /**
         * @var \Viauco\Messenger\Models\Discussion  $first
         * @var \Viauco\Messenger\Models\Discussion  $last
         */
    ...
    public function it_can_get_count_of_all_unread_messages_for_user()
    {
        /**
         * @var \Viauco\Messenger\Models\Discussion   $discussion
         * @var \Viauco\Messenger\Models\Participation  $participantOne
         * @var \Viauco\Messenger\Models\Participation  $participantTwo
         */
        $discussion = $this->factory->create(Discussion::class);
        $discussion->participations()->saveMany([
            $participantOne = $this->factory->make(Participation::class),
